    ...
    <div className={style.blog}>
      ...
      <main>
        ...
        <div className={style.blogPage}>
          <section className={style.blogSnippet}>
          ...
          <section className={`${style.flexContainer} ${style.blogCards}`}>
            <article className={style.blogCard1}>
              <div className={style.featuredBlog}>
                ...
                <h4>
                  ...
                  studying, learning and working in the Kitchen. The breakdown
                  of the tricks to use in cooking to ease yourself.
                </h4>
                <a href="">Read more</a>
              </div>
              <img src={Laraba} alt="blog " />
            </article>
            <article className={style.blogCard2}>
          ...
          <div className={style.blogCategories}>
            ...
            <section
              className={`${style.flexContainer} ${style.allCategories}`}
            >
              <div className={style.lifestyleCategory}>
                <div>
                  ...
                  <h3>Lifestyle</h3>
                  <h4>
                    Love made me to start growing rare and wild species of
                    plants
                  </h4>
                  <div className={`${style.flexContainer} ${style.blogDate}`}>
                    <img src={Sarafina} alt="blog " />
          ...
          <section className={`${style.flexContainer} ${style.newsLetter}`}>
            <div>
              <h2>
